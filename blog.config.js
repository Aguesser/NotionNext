...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '15f9031693168090a81cc2d7e44d4ec4',
  ...
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 900, // 更新缓存间隔 单位(秒)；即每个页面有900秒的纯静态期、此期间无论多少次访问都不会抓取notion数据；调大该值有助于节省Vercel资源、同时提升访问速率，但也会使文章更新有延迟。
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Aguesser', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '记录游戏设计与心理学的学习与思考', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-aguessers-projects.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '游戏设计, 心理, 教育, 博客', // 网站关键词 英文逗号隔开
